export default {
  ...
  communitySection: "Sitio web oficial",
  communityHint: "Visita el sitio web oficial para obtener las últimas actualizaciones.",
  communityButton: "Visitar www.hermeswindos.com",
} as const;
